...
// Função para converter o link do YouTube de 'watch' para 'embed'
function convertYoutubeUrlToEmbed($url) {
    // Verifica se o link contém 'watch?v=' (URL normal do YouTube)
...
// Converte o link do trailer para embed automaticamente
$movie->trailer = convertYoutubeUrlToEmbed($movie->trailer);
...
<div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md-1 col-md-6 movie-container">
            ...
            <!-- Trailer do filme com URL convertida -->
